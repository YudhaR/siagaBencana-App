...
import methodLaporan.dataLaporan;
import methodLaporan.laporanController;
...
public class Laporan extends javax.swing.JFrame {
    ...
    List<dataLaporan> ListLaporan = new ArrayList<dataLaporan>();
    ...
    private void showTable(){
        ...
        ListLaporan.clear();
        ListLaporan=lc.viewLaporan();
        for(x=0;x<ListLaporan.size();x++){
            Object[] data = new Object[7];
            data[0] = ListLaporan.get(x).getidLaporan();
            data[1] = ListLaporan.get(x).getnameUser();
            data[2] = ListLaporan.get(x).getnoHP();
            data[3] = ListLaporan.get(x).getdeskripsi();
            data[4] = ListLaporan.get(x).getdaerahBencana();
            data[5] = ListLaporan.get(x).gettanggalBencana();
            model.addRow(data);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Nomor Laporan  :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jButton1.getText().equalsIgnoreCase("Tambah")){
            ...
            clean();
            siapIsi(true);
            int idIndex = ListLaporan.isEmpty() ? 1 : ListLaporan.get(ListLaporan.size() - 1).getidLaporan() + 1;
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if(txtUser1.getText().isEmpty() || txtUser2.getText().isEmpty() || txtUser3.getText().isEmpty() || txtUser4.getText().isEmpty() ||  txtUser5.getText().isEmpty() || txtUser6.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Data Harus Lengkap", "Pesan", JOptionPane.INFORMATION_MESSAGE);
        }else{
            int idLaporan = Integer.parseInt(txtUser1.getText());
            dl.setidLaporan(idLaporan);
            dl.setnameUser(txtUser2.getText());
            int noHP = Integer.parseInt(txtUser3.getText());
            dl.setnoHP(noHP);
            dl.setdeskripsi(txtUser5.getText());
            dl.setdaerahBencana(txtUser4.getText());
            dl.settanggalBencana(txtUser6.getText());
            if(jButton1.getText().equalsIgnoreCase("Batal")){
                if (lc.addLaporan(dl)==1){
