...
public class loginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/Bantuan Bencana.png"))); // NOI18N
        ...
        jPanel3.setBackground(new java.awt.Color(31, 32, 34));

        jPanel1.setBackground(new java.awt.Color(31, 32, 34));

        jLabel2.setBackground(new java.awt.Color(0, 0, 0));
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/cross-small1.png"))); // NOI18N
        ...
        jPanel5.setBackground(new java.awt.Color(31, 32, 34));

        jLabel5.setBackground(new java.awt.Color(64, 110, 171));
        jLabel5.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(64, 110, 171));
        jLabel5.setText("Username / Email");

        txtUser.setBackground(new java.awt.Color(31, 32, 34));
        txtUser.setForeground(new java.awt.Color(255, 255, 255));
        txtUser.setBorder(null);

        jLabel6.setBackground(new java.awt.Color(64, 110, 171));
        ...
        jPanel6.setBackground(new java.awt.Color(31, 32, 34));

        jLabel7.setBackground(new java.awt.Color(64, 110, 171));
        jLabel7.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(64, 110, 171));
        jLabel7.setText("Password");

        jLabel8.setBackground(new java.awt.Color(64, 110, 171));
        jLabel8.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("_____________________________________________");

        txtPass.setBackground(new java.awt.Color(31, 32, 34));
        ...
        btnLog.setBackground(new java.awt.Color(126, 86, 191));
    ...
    private void btnLogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogActionPerformed
        if(txtUser.getText().equals("")||txtPass.getText().equals("")){
            ...
            try{
                //                ListLogin = uc.searchLogin(txtUser.getText(), dataEnkripsi.getSHA1(txtPass.getText()));
                ListLogin = uc.searchLogin(txtUser.getText(), txtPass.getText());
                if (ListLogin.get(0).getRole().equalsIgnoreCase("admin") || ListLogin.get(0).getRole().equalsIgnoreCase("relawan")){
                    mainMenu mnu = new mainMenu();
                    mnu.setVisible(true);
                    mnu.viewUser(txtUser.getText());
                    dispose();
                }else{
                    JOptionPane.showMessageDialog(null, "Username atau password tidak ditemukan \n Harap ulangi", "Pesan", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnLogMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLogMouseEntered
        btnLog.setBackground(new Color(64, 43, 100));
    ...
    private void btnLogMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLogMouseExited
        btnLog.setBackground(new Color(126,86,191));
    ...
    List<dataUser> ListLogin = new ArrayList<dataUser>();
